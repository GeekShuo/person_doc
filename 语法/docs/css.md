...
查看: [Flexbox](css.md#css-flexbox) | [Flex Tricks](css.md#css-flexbox-技巧)
...
属性 | 说明
:- | :-
`background:` | _([速记](css.md#速记-1))_
`background-color:`      | 查看: [Colors](css.md#css-颜色)
