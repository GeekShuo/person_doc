...
配置 | Type | 描述
:--- | --- | ---
`pattern` | [PatternKind](tauri.md#patternkind) | 应用程序名称
`version` | [WindowConfig\[\]](tauri.md#windowconfig) | 应用程序版本
`cli` | [CliConfig](tauri.md#cliconfig) | CLI 配置
`bundle` | BundleConfig | 打包器配置
`allowlist` | AllowlistConfig | 允许列表配置
`security` | SecurityConfig | 安全配置
`updater` | UpdaterConfig | 更新程序配置
`systemTray` | [SystemTrayConfig](tauri.md#systemtrayconfig) | 配置应用系统托盘
...
`url` | [WindowUrl](tauri.md#windowurl) | view | 窗口的 webview URL
