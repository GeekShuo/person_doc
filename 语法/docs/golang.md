...
或者在 [Go repl](https://repl.it/languages/go) 中尝试一，`go` 命令[参考](golang.md#go-命令)
...
参见：[函数(Functions)](golang.md#golang-函数)
