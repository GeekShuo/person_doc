---
title: "计算机网络面试速查题库"
source: "https://onefly.top/zero2Leetcode/05_interview/fundamentals/computer-network/index.html"
---

# 计算机网络面试速查题库

> 本页用于学完后的复习与面试表达。第一次学习请从 [计算机网络系统课](../cs-core/computer-network/index.md) 开始，先建立分层、路由、可靠传输和应用协议的完整模型。
>
