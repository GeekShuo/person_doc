...
source: "https://onefly.top/zero2Leetcode/05_interview/fundamentals/cs-core/computer-network/05-tls-debugging/index.html"
---
...
10. 解释多层重试怎样放大故障。
11. 用 dig + curl 分阶段记录一个站点请求。
12. 用 openssl s_client 查看证书链和协商结果。
13. 对一个不存在端口比较 RST 与超时。
14. 画出浏览器、递归 DNS、路由器、负载均衡和服务端之间的数据流。
