---
title: "计算机基础系统课"
source: "https://onefly.top/zero2Leetcode/05_interview/fundamentals/cs-core/index.html"
---
...
1. [导学：程序如何在硬件上运行](computer-organization/index.md)
2. [数据表示、指令与程序执行](computer-organization/01-data-and-instructions/index.md)
3. [CPU、流水线与性能](computer-organization/02-cpu-pipeline-performance/index.md)
4. [存储层次、Cache 与局部性](computer-organization/03-memory-cache/index.md)
5. [中断、DMA、多核与缓存一致性](computer-organization/04-io-multicore/index.md)

### 第二阶段：操作系统

1. [导学：操作系统怎样管理程序](operating-system/index.md)
2. [内核、系统调用、进程与线程](operating-system/01-kernel-process-thread/index.md)
3. [调度、同步、锁与死锁](operating-system/02-scheduling-concurrency/index.md)
4. [地址空间、分页、TLB 与缺页](operating-system/03-virtual-memory/index.md)
5. [文件系统、I/O、epoll 与零拷贝](operating-system/04-filesystem-io/index.md)
6. [Linux 观测与故障定位](operating-system/05-linux-observability/index.md)

### 第三阶段：计算机网络

1. [导学：一次请求怎样到达服务器](computer-network/index.md)
2. [分层、以太网、MAC 与 ARP](computer-network/01-layers-link/index.md)
3. [IP、子网、路由、ICMP 与 NAT](computer-network/02-ip-routing/index.md)
4. [UDP、TCP 与可靠传输](computer-network/03-transport-tcp/index.md)
5. [DNS、HTTP、缓存与连接演进](computer-network/04-dns-http/index.md)
6. [TLS、完整请求链路与网络排障](computer-network/05-tls-debugging/index.md)
