---
title: "操作系统面试速查题库"
source: "https://onefly.top/zero2Leetcode/05_interview/fundamentals/operating-system/index.html"
---

# 操作系统面试速查题库

> 本页用于学完后的复习与面试表达。第一次学习请从 [操作系统系统课](../cs-core/operating-system/index.md) 开始，先理解内核状态、资源队列和完整执行路径。
>
