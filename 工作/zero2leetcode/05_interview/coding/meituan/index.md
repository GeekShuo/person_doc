...
source: "https://onefly.top/zero2Leetcode/05_interview/coding/meituan/index.html"
---
...
| 2 | [LC 102 二叉树的层序遍历](../../../playground.md) | **5** | BFS + 队列 |
| 2 | [LC 206 反转链表](../../../playground.md) | **5** | 迭代 / 递归 |
| 2 | [LC 88 合并两个有序数组](https://leetcode.cn/problems/merge-sorted-array/)（本站练习场暂未收录） | **5** | 逆向双指针 |
| 2 | [LC 142 环形链表 II](../../../playground.md) | **5** | Floyd 快慢指针 |
| 7 | [LC 141 环形链表](../../../playground.md) | **4** | 快慢指针 |
| 8 | [LC 21 合并两个有序链表](../../../playground.md) | **3** | 双指针 + 哨兵节点 |
| 8 | [LC 215 数组中的第 K 个最大元素](../../../playground.md) | **3** | 快速选择 / 堆 |
| 8 | [LC 144 二叉树的前序遍历](https://leetcode.cn/problems/binary-tree-preorder-traversal/)（本站练习场暂未收录） | **3** | 递归 / 迭代栈 |
| 8 | [LC 19 删除链表的倒数第 N 个节点](../../../playground.md) | **3** | 快慢指针 |
...
| 12 | [LC 32 最长有效括号](../../../playground.md) | **2** | DP / 栈 |
...
| 题目 | 主要考点 |
|---|---|
| [LC 146 LRU 缓存](../../../playground.md) | 哈希表 + 双向链表 |
...
| [LC 32 最长有效括号](../../../playground.md) | DP / 栈 |
...
| [LC 23 合并 K 个升序链表](../../../playground.md) | 优先队列 / 分治 |
...
| [LC 42 接雨水](../../../playground.md) | 双指针 / 单调栈 |
...
| 题目 | 主要考点 |
|---|---|
| [LC 124 二叉树中的最大路径和](../../../playground.md) | 后序遍历 + 全局最优值 |
| [LC 128 最长连续序列](../../../playground.md) | 哈希集合 |
| [LC 236 二叉树的最近公共祖先](../../../playground.md) | 递归后序遍历 |
...
| 题目 | 主要考点 |
|---|---|
| [LC 5 最长回文子串](../../../playground.md) | 中心扩展 / DP |
