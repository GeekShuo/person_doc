---
title: "华为AI岗 7.24"
source: "https://onefly.top/zero2Leetcode/04_real_interviews/huawei/ai-20260724/index.html"
---
...
A. $\dfrac12$ B. $\dfrac23$ C. $\dfrac34$ D. $1$
...
**答案**：B **难度**：简单 **考点**：机器学习—交叉熵 **解析**：多分类交叉熵为 $-\sum_i y_i\log p_i$。one-hot 标签只有真实类别对应项为 $1$，所以损失就是该类别预测概率的负对数，即 $-\log0.8$。
