---
title: "拼多多算法岗 8.23"
source: "https://onefly.top/zero2Leetcode/04_real_interviews/pinduoduo/algo-20260823/index.html"
---
...
1. 若 $b<B$，在原地充一格电： \[(v,b)\to(v,b+1),\qquad \text{代价 }s_v.\]
2. 对道路 $(v,u,a,w)$，若 $b\ge a$，则可以通行： \[(v,b)\to(u,b-a),\qquad \text{代价 }w.\]
...
- `D u v w` 加入 \[x_u-x_v=w,\qquad (-x_u)-(-x_v)=-w;\]
- `S u v w` 加入 \[x_u-(-x_v)=w,\qquad (-x_u)-x_v=-w.\]
