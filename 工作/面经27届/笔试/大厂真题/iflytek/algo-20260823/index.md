---
title: "科大讯飞算法岗 8.23"
source: "https://onefly.top/zero2Leetcode/04_real_interviews/iflytek/algo-20260823/index.html"
---
...
1. **$x\ne k-x$**：如果两组中都保留按钮，就一定能选出一对使数字和为 $k$。所以必须关闭其中完整的一组，最小代价为 \[\min(\operatorname{cnt}[x],\operatorname{cnt}[k-x]).\]
2. **$x=k-x$**：即 $2x=k$。同组中只要留下至少两个按钮就会爆炸，所以最多保留一个，最小代价为 \[\operatorname{cnt}[x]-1.\]
