...
source: "https://onefly.top/zero2Leetcode/05_interview/fundamentals/kubernetes-agent-infra/index.html"
---
...
> 如果要先建立 OS、云计算、训推、分布式与 Agent Runtime 的完整知识链，先看 [AI Infra 系统面试总纲](../infra-systems/index.md)。
>
