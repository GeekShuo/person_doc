---
title: "输入输出与 ACM 模式"
source: "https://onefly.top/zero2Leetcode/00_python_basics/06-input-output/index.html"
---
...
| [← 返回 Python 基础](../index.md) | [上一篇：刷题工具与调试](../05-coding-tricks/index.md) | [下一章：数据结构 →](../../../leetcode/01_data_structures/index.md) |
|---|---|---|
