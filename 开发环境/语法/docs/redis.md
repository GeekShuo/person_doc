...
- [Strings(字符串)](redis.md#redis-字符串类型设置)
- [Lists(列表)](redis.md#redis-列表类型设置)
- [Hashes(哈希)](redis.md#redis-哈希类型设置)
- [Sets(集合)](redis.md#redis-集合类型设置)
- [Sorted Sets(有序集合)](redis.md#redis-排序集类型设置)
