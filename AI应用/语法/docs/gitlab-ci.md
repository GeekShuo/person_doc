...
关键字 | 描述
:-- | --
[default](gitlab-ci.md#default) | 工作关键字的自定义默认值 [#](https://docs.gitlab.com/ee/ci/yaml/#default)
[include](gitlab-ci.md#include) | 从其他 YAML 文件导入配置 [#](https://docs.gitlab.com/ee/ci/yaml/#include)
[stages](gitlab-ci.md#stages) | 管道阶段的名称和顺序 [#](https://docs.gitlab.com/ee/ci/yaml/#stages)
[variables](gitlab-ci.md#variables) | 为管道中的所有作业定义 CI/CD 变量 [#](https://docs.gitlab.com/ee/ci/yaml/#variables)
[workflow](gitlab-ci.md#workflow) | 控制运行什么类型的管道 [#](https://docs.gitlab.com/ee/ci/yaml/#workflow)
...
关键字 | 描述
:-- | --
[after_script](gitlab-ci.md#after_script) | 覆盖一组在作业之后执行的命令 [#](https://docs.gitlab.com/ee/ci/yaml/#after_script)
[allow_failure](gitlab-ci.md#allow_failure) | 允许作业失败。失败的作业不会导致管道失败 [#](https://docs.gitlab.com/ee/ci/yaml/#allow_failure)
[artifacts](gitlab-ci.md#artifacts) | 成功时附加到作业的文件和目录列表 [#](https://docs.gitlab.com/ee/ci/yaml/#artifacts)
[before_script](gitlab-ci.md#before_script) | 覆盖在作业之前执行的一组命令 [#](https://docs.gitlab.com/ee/ci/yaml/#before_script)
[cache](gitlab-ci.md#cache) | 应在后续运行之间缓存的文件列表 [#](https://docs.gitlab.com/ee/ci/yaml/#cache)
[coverage](gitlab-ci.md#coverage) | 给定作业的代码覆盖率设置 [#](https://docs.gitlab.com/ee/ci/yaml/#coverage)
[dast_configuration](gitlab-ci.md#dast_configuration) | 在作业级别使用 DAST 配置文件中的配置 [#](https://docs.gitlab.com/ee/ci/yaml/#dast_configuration)
[dependencies](gitlab-ci.md#dependencies) | 通过提供要从中获取工件的作业列表来限制将哪些工件传递给特定作业 [#](https://docs.gitlab.com/ee/ci/yaml/#dependencies)
[environment](gitlab-ci.md#environment) | 作业部署到的环境的名称 [#](https://docs.gitlab.com/ee/ci/yaml/#environment)
[except](gitlab-ci.md#only--except) | 控制何时不创建作业 [#](https://docs.gitlab.com/ee/ci/yaml/#only--except)
[extends](gitlab-ci.md#extends) | 此作业继承自的配置条目 [#](https://docs.gitlab.com/ee/ci/yaml/#extends)
[image](gitlab-ci.md#image) | 使用 Docker 镜像 [#](https://docs.gitlab.com/ee/ci/yaml/#image)
[inherit](gitlab-ci.md#inherit) | 选择所有作业继承的全局默认值 [#](https://docs.gitlab.com/ee/ci/yaml/#inherit)
[interruptible](gitlab-ci.md#interruptible) | 定义作业是否可以在被较新的运行冗余时取消 [#](https://docs.gitlab.com/ee/ci/yaml/#interruptible)
[needs](gitlab-ci.md#needs) | 在阶段排序之前执行作业 [#](https://docs.gitlab.com/ee/ci/yaml/#needs)
[only](gitlab-ci.md#only--except) | 控制何时创建作业 [#](https://docs.gitlab.com/ee/ci/yaml/#only--except)
[pages](gitlab-ci.md#pages) | 上传作业的结果以与 GitLab Pages 一起使用 [#](https://docs.gitlab.com/ee/ci/yaml/#pages)
[parallel](gitlab-ci.md#parallel) | 应并行运行多少个作业实例 [#](https://docs.gitlab.com/ee/ci/yaml/#parallel)
[release](gitlab-ci.md#release) | 指示运行器生成释放对象 [#](https://docs.gitlab.com/ee/ci/yaml/#release)
[resource_group](gitlab-ci.md#resource_group) | 限制作业并发 [#](https://docs.gitlab.com/ee/ci/yaml/#resource_group)
[retry](gitlab-ci.md#retry) | 发生故障时可以自动重试作业的时间和次数 [#](https://docs.gitlab.com/ee/ci/yaml/#retry)
[rules](gitlab-ci.md#rules) | 用于评估和确定作业的选定属性以及是否创建的条件列表 [#](https://docs.gitlab.com/ee/ci/yaml/#rules)
[script](gitlab-ci.md#script) | 由运行器执行的 Shell 脚本 [#](https://docs.gitlab.com/ee/ci/yaml/#script)
[secrets](gitlab-ci.md#secrets) | CI/CD 保密工作需要 [#](https://docs.gitlab.com/ee/ci/yaml/#secrets)
[services](gitlab-ci.md#services) | 使用 Docker 服务映像 [#](https://docs.gitlab.com/ee/ci/yaml/#services)
[stage](gitlab-ci.md#stage) | 定义作业阶段 [#](https://docs.gitlab.com/ee/ci/yaml/#stage)
[tags](gitlab-ci.md#tags) | 用于选择跑步者的标签列表 [#](https://docs.gitlab.com/ee/ci/yaml/#tags)
[timeout](gitlab-ci.md#timeout) | 定义优先于项目范围设置的自定义作业级超时 [#](https://docs.gitlab.com/ee/ci/yaml/#timeout)
[trigger](gitlab-ci.md#trigger) | 定义下游管道触发器 [#](https://docs.gitlab.com/ee/ci/yaml/#trigger)
[variables](gitlab-ci.md#variables) | 在作业级别定义作业变量 [#](https://docs.gitlab.com/ee/ci/yaml/#variables)
[when](gitlab-ci.md#when) | 何时运行作业 [#](https://docs.gitlab.com/ee/ci/yaml/#when)

### 全局关键词

- [after_script](gitlab-ci.md#after_script)
- [artifacts](gitlab-ci.md#artifacts)
- [before_script](gitlab-ci.md#before_script)
- [cache](gitlab-ci.md#cache)
- [image](gitlab-ci.md#image)
- [interruptible](gitlab-ci.md#interruptible)
- [retry](gitlab-ci.md#retry)
- [services](gitlab-ci.md#services)
- [tags](gitlab-ci.md#tags)
- [timeout](gitlab-ci.md#timeout)
...
- [.pre](gitlab-ci.md#stage-pre)
- build
- test
- deploy
- [.post](gitlab-ci.md#stage-post)
...
工作流(workflow)中的 `rules` 关键字类似于作业中定义的 [`rules`](gitlab-ci.md#rules)，但控制是否创建整个管道

- [rules: if](gitlab-ci.md#rulesif)
- [rules: changes](gitlab-ci.md#ruleschanges)
- [rules: exists](gitlab-ci.md#rulesexists)
- [when](gitlab-ci.md#when)
- [variables](gitlab-ci.md#workflowrulesvariables)
<!--rehype:className=cols-2-->
...
`never` | 不要运行作业。只能在规则[rules](gitlab-ci.md#rules)部分或工作流中使用：`workflow: rules`
...
:- | --
:- | --
[release:tag_name](gitlab-ci.md#releasetag_name) | 发布的 Git 标签
[release:tag_message](gitlab-ci.md#releasetag_message) | 指定的消息进行注释
[release:name](gitlab-ci.md#releasename) | 发布名称
[release:description](gitlab-ci.md#releasedescription) | 版本的详细描述
[release:ref](gitlab-ci.md#releaseref) | 发布的 ref
[release:milestones](gitlab-ci.md#releasemilestones) | 每个里程碑的标题
[release:released_at](gitlab-ci.md#releasereleased_at) | 发布准备就绪的日期和时间
