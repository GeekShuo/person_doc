...
查看: [f-字符串](python.md#python-f-字符串-python-36)
...
只能有一个，与向函数传递[位置参数](python.md#位置参数)时的 `*` 别无二致。
