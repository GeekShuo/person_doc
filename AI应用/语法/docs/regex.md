...
- [Python 中的 Regex](regex.md#python-中的正则表达式)  
    _(速查手册)_
- [JavaScript 中的 Regex](regex.md#javascript-中的正则表达式)  
    _(速查手册)_
- [PHP 中的 Regex](regex.md#php中的正则表达式)  
    _(速查手册)_
- [Java 中的 Regex](regex.md#java-中的正则表达式)  
    _(速查手册)_
- [MySQL 中的 Regex](regex.md#mysql中的正则表达式)  
    _(速查手册)_
- [Vim 中的 Regex](./vim.md#vim-搜索和替换)  
    _(速查手册)_
